...
@if ($message = Session::get('success'))
  ...
  <div class="text-right">
    <a class="btn btn-success" href="{{ route('unites.create') }}"><i class="fas fa-plus-square" ></i> Ajouter une nouvelle unité </a>
</div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="employee_table">
                  <thead>
                   ...
                   <td>{{ $unite->reference }}</td>
                   <td>{{ $unite->designation }}</td>
                   <td>{{ $unite->symbole }}</td>
                   <td>
                   <form action="{{ route('unites.destroy',$unite->id_auto) }}" method="POST">

                           <a class="btn btn-warning " href="{{ route('unites.edit',$unite->id_auto) }}">
