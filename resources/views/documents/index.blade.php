...
@if ($message = Session::get('success'))
  ...
  <div class="text-right">
    <a class="btn btn-success" href="{{ route('documents.create') }}"><i class="fas fa-plus-square" ></i> Ajouter une nouvelle facture</a>
</div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap"  id="employee_table">
                  <thead>
                   ...
                   <td>{{ $document->document_dateajout }}</td>
                   <td>{{ $document->agent_id }}</td>
                  

                   <td>
                    <form action="{{ route('documents.destroy',$document->id_auto) }}" method="POST">

                           <a class="btn btn-warning " href="{{ route('documents.edit',$document->id_auto) }}">
