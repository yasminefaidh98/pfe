    ...
    <form action="{{ route('ventes.store') }}" method="POST" >
        ...
        <div class="form-row">
            ...
            <div class=" col-md-6 ">
                    ...
                    <input type="number" name="agent_reference" class="form-control" ><br/>
                </div>
            ...
            <div class="col-md-6">
                    ...
                    <input type="text" name="agent_raisonsocial" class="form-control" ><br/>
                </div>
            
            
             <div class="col-md-6">
                
                    <strong>Matriclue fiscale:</strong>
                    <input type="text" name="agent_matriculefiscale" class="form-control" ><br/>
               
            </div>
            <div class="col-md-6">
                    <strong>
                    Site web:</strong>
                    <input type="text" name="agent_siteweb" class="form-control" ><br/>
            </div>
            <div class="col-md-6">
                    <strong>
                    Adresse:</strong>
                    <input type="text" name="agent_adresse" class="form-control" ><br/>
                </div>
                <div class="col-md-6">
                    <strong>
                    Famille:</strong>
                    <input type="text" name="famille_agent_id" class="form-control" ><br/>
                </div>
                <div class="col-md-6">
                    <strong>
                    Région:</strong>
                ...
                <div class="col-md-6">
                    <strong>
                    Actif:</strong>
                    <input type="number" name="actif" class="form-control" ><br/>
                </div>
