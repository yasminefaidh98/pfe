    ...
    <form action="{{ route('categories.store') }}" method="POST" >
        ...
        <div class="form-row col-md-12">
            <div class="col-md-6 text-left">
                    ...
                    <strong>Id :</strong>
                    <input type="number" name="id_auto" class="form-control" placeholder="auto"><br/>
            </div>
           
            <div class="col-md-6 text-left">
          
                    <strong>Réference:</strong>
                    <input type="number" name="reference" class="form-control" placeholder=""><br/>
                </div>
           
            <div class="col-md-6 text-left">
            
                    <strong>Désignation:</strong>
                    <input type="text" name="designation" class="form-control" placeholder=""><br/>
                </div>
