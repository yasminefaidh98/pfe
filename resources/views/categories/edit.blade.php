...
<div class="wrapper">
  ...
  @section('content') 
    ...
    <form action="{{ route('categories.update',$categories->id_auto) }}" method="POST" class="form-style-9">
    @csrf
    @method('PUT')
    <div class="form-row ">
    ...
    <div class=" col-md-6 text-left">
      ...
      <input type="text" class="form-control" name="reference"  value="{{ $categories->reference }}"><br/>
    </div>
    <div class=" col-md-6 text-left">
      <label > Designation  : </label>
      <input type="text" class="form-control" name="designation" value="{{ $categories->designation }}"><br/>
    </div>
    <div class=" col-md-6 text-left">
    <!--<select >
    ...
    <option> {{$categorie->designation}} </option>
      </select>
      @endforeach -->

      <label > Categorie  : </label>
      <input type="text" class="form-control"  name="categorie" value="{{ $categories->categorie }}"><br/>
    </div>
