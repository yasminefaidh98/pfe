...
class CreateStdFamilleSupplierTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('std_famille_supplier', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('std_famille_supplier');
    }
}
